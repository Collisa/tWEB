<template>
  ...
  <nav class="">
    ...
    <div class="flex flex-row justify-between px-8 py-5 items-center relative">
      ...
      <button @click="isActive = !isActive" v-click-away="onClickAway" class="md:hidden rounded focus:outline-none focus:ring-2 focus:ring-purplepink-400 focus:ring-opacity-40">
      ...
      <div class="absolute md:hidden top-16 right-8">

        <div v-show="isActive" class="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3 items-end md:items-center bg-gray-950 p-4 md:p-0 rounded-xl md:bg-black">
      ...
      <div class="hidden md:flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-3 items-end md:items-center bg-gray-950 p-4 md:p-0 rounded-xl md:bg-black">
        <div class="inline-block relative">
          <router-link
              exact-active-class="bg-purplepink-400 bg-opacity-40 text-pink-300 text-opacity-50"
              class="p-1 rounded-md hover:bg-opacity-20 hover:text-opacity-50"
  ...
  computed: {
    ...
    getCurrentHoverColor() {
      switch(this.currentRouteName) {
        case "Home":
          return "hover:text-pink-200 hover:bg-purplepink-400";
        case "About":
          return "hover:text-teal-500 hover:bg-teal-500";
        case "Portfolio":
          return "hover:text-white hover:bg-white";
        case "Contact":
          return "hover:text-orange-500 hover:bg-orange-500";
        case "Samenwerking":
          return "hover:text-lime-500 hover:bg-lime-500";
      }
    }
  },
}
